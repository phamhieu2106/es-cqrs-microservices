...
public class UpdateCustomerEvent extends BaseEvent {
    String customerId;
    String customerCode;
    String customerName;
    Gender gender;
    ...
    public UpdateCustomerEvent(Date date, String customerId, String customerCode, String customerName, Gender gender
            , String phoneNumber, String email, Date dateOfBirth, List<AddressModel> addressModels
            , String jobName, IdentityModel proof, StatusCustomer statusCustomer, String createdBy) {
