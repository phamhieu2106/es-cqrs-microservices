...
public class InsuranceUpdateEvent extends BaseEvent {
    Date timestamp;
    ...
    public InsuranceUpdateEvent(Date timestamp, String insuranceId, String insuranceCode,String insuranceName
